...
class GuiButton(
    ...
    override fun drawButton(mc: Minecraft?, mouseX: Int, mouseY: Int) {
        ...
        text(this.displayString, this.xPosition + this.width / 2f, this.yPosition + height / 2f, Color.WHITE, textSize / scaleFactor, FontRenderer.REGULAR, TextAlign.Middle, TextPos.Middle, true)
    }
