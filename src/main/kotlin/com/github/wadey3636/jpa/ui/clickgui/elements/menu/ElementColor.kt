...
import com.github.wadey3636.jpa.ui.clickgui.util.ColorUtil.hsbMax
...
class ElementColor(parent: ModuleButton, setting: ColorSetting) :
    ...
    override fun draw() {
        ...
        text(hexString, x + w / 2, y + 271, Color.WHITE, 12f, FontRenderer.REGULAR, TextAlign.Middle, TextPos.Middle)
